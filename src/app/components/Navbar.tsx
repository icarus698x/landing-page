    ...
    >
      ...
      >
        ...
        <Link to="/" className="flex items-center gap-2">
          <span
            className="font-semibold tracking-widest text-sm transition-colors duration-300"
            style={{ color: "#111827" }}
          >
            xOpsentia
          </span>
        ...
        {/* Contact Us — pinned right */}
        <div className="absolute right-6 top-1/2 -translate-y-1/2">
          <Link
            to="/contact"
            className="px-4 py-2 text-sm font-semibold transition-all duration-300 hover:opacity-90 inline-block"
            style={{
              background: "#0D9488",
              color: "white",
              borderRadius: 7,
